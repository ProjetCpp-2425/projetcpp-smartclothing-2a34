...
""));
        ...
        MAIL_input = new QLineEdit(widget_24);
        MAIL_input->setObjectName("MAIL_input");
        MAIL_input->setGeometry(QRect(370, 220, 221, 31));
        label_81 = new QLabel(widget_24);
        label_81->setObjectName("label_81");
        label_81->setGeometry(QRect(400, 160, 91, 31));
        label_82 = new QLabel(widget_24);
        label_82->setObjectName("label_82");
        label_82->setGeometry(QRect(400, 290, 91, 31));
        DATE_input = new QDateEdit(widget_24);
        DATE_input->setObjectName("DATE_input");
        DATE_input->setGeometry(QRect(410, 350, 110, 25));
...
""));
        btnClassify = new QPushButton(tabWidgetPage1);
        btnClassify->setObjectName("btnClassify");
        btnClassify->setGeometry(QRect(960, 460, 80, 24));
        ...
        searchInput = new QLineEdit(tabWidgetPage2);
        searchInput->setObjectName("searchInput");
        searchInput->setGeometry(QRect(100, 110, 271, 31));
        searchInput->setStyleSheet(QString::fromUtf8(""));
        searchInput->setMaxLength(8);
        ...
        tableView_2 = new QTableView(tabWidgetPage2);
        tableView_2->setObjectName("tableView_2");
        tableView_2->setGeometry(QRect(220, 190, 711, 191));
...
""));
        searchButton = new QPushButton(tabWidgetPage2);
        searchButton->setObjectName("searchButton");
        searchButton->setGeometry(QRect(60, 190, 121, 61));
        tabWidget_client->addTab(tabWidgetPage2, QString());
        tab_6 = new QWidget();
        tab_6->setObjectName("tab_6");
        chartLayout = new QFrame(tab_6);
        chartLayout->setObjectName("chartLayout");
        chartLayout->setGeometry(QRect(60, 30, 821, 461));
        chartLayout->setFrameShape(QFrame::Shape::StyledPanel);
        chartLayout->setFrameShadow(QFrame::Shadow::Raised);
        statsButton = new QPushButton(tab_6);
        statsButton->setObjectName("statsButton");
        statsButton->setGeometry(QRect(920, 30, 161, 81));
        tabWidget_client->addTab(tab_6, QString());
        envoyersms = new QWidget();
        envoyersms->setObjectName("envoyersms");
        comb_client = new QComboBox(envoyersms);
        comb_client->addItem(QString());
        comb_client->addItem(QString());
        comb_client->setObjectName("comb_client");
        comb_client->setGeometry(QRect(40, 70, 211, 61));
...
""));
        ...
        tabWidget_client->setCurrentIndex(1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_81->setText(QCoreApplication::translate("MainWindow", "MAIL", nullptr));
        label_82->setText(QCoreApplication::translate("MainWindow", "Date ", nullptr));
        ...
        btnClassify->setText(QCoreApplication::translate("MainWindow", "Classify", nullptr));
        ...
        trier->setItemText(0, QCoreApplication::translate("MainWindow", "Date d'inscription", nullptr));
        trier->setItemText(1, QCoreApplication::translate("MainWindow", "Prenom", nullptr));
        trier->setItemText(2, QCoreApplication::translate("MainWindow", "Nom", nullptr));
        trier->setItemText(3, QString());

        trier->setCurrentText(QCoreApplication::translate("MainWindow", "Date d'inscription", nullptr));
        ...
        statsButton->setText(QCoreApplication::translate("MainWindow", "ShowStats", nullptr));
        tabWidget_client->setTabText(tabWidget_client->indexOf(tab_6), QCoreApplication::translate("MainWindow", "Statistique", nullptr));
        comb_client->setItemText(0, QCoreApplication::translate("MainWindow", "Normal", nullptr));
        comb_client->setItemText(1, QCoreApplication::translate("MainWindow", "VIP", nullptr));
        ...
        envoyer_mail->setText(QCoreApplication::translate("MainWindow", "Envoyer par  Mail", nullptr));
